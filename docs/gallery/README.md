...
Drop image files in this folder (`docs/gallery/`). Then add a row to `docs/data/gallery.json`. They show under **our photos** (`photos.html`), with a short preview on the guide. They do not replace the photos on place cards.
