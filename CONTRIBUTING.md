...
- Your own photos: drop the file in `docs/gallery/`, then add a row to `docs/data/gallery.json` (caption, optional `lat`/`lng`). They show in their own section on the page. Details are in `docs/gallery/README.md`.
