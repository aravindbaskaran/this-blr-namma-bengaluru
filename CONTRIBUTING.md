...
- Your own photos: drop the file in `docs/gallery/`, then add a row to `docs/data/gallery.json` (caption, optional `locationId` or `lat`/`lng`). Details are in `docs/gallery/README.md`.
